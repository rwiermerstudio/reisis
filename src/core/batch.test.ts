...
describe('compiled batch evaluation', () => {
  it('evaluates 5,000 PFT records with compact results', () => {
    const dataset = largeDataset(5_000);
    ...
    expect(results[4_999]).toEqual({ mfn: 5_000, output: 'ID-005000 / Synthetic title 5000' });
