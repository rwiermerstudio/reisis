...
- Format-valued `proc()` with local `D`, `A`, and `H` field updates
...
- 72 executable lessons with local progress across PFT, FST, expressions,
...
- 424 automated behavioral cases, including 10,000-record import, persistence, and PFT runs
